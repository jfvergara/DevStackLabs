...
const content = {
  en: {
    title: "Support – Florería Pro",
    description:
      "For questions or issues with Florería Pro, email us and we'll get back to you as soon as possible.",
    contactLabel: "Email support",
    backToProduct: "Back to Florería Pro",
  },
  es: {
    title: "Soporte – Florería Pro",
    description:
      "Para dudas o problemas con Florería Pro, escríbenos y te responderemos lo antes posible.",
...
export async function generateMetadata({
  ...
  return {
    ...
    openGraph: {
      title: t.title,
      url: `https://www.devstacklabs.com/${locale}/products/floreriapro/soporte`,
    },
  };
}

export default async function FloreriaProSoportePage({
  params,
}: SoportePageProps) {
  const { locale } = await params;
